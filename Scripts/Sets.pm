...
# (min - max) = A . ( a1 - a2 ) 
# A = (min - max) / (a1 - a2)
# B = min - A . a1 = min ( a1 - a2 ) / (a1 - a2) - a1 . (min - max) / (a1 - a2)
#
# B = [ min . (a1 - a2) - a1 . (min - max) ] / (a1 - a2)
#
# B = [ a1 . max - a2 . min ] / ( a1 - a2 )   
...
# 
# A  = (a1 - a2) / (min - max)
# B  = a1 - (a1 - a2) . min / (min - max)
#
# B  = [ a1 . (min - max) - (a1 - a2). min ] / (min - max)
#    = [ - a1 . max + a2 . min ] / (min - max)    
...
sub getREMotifPositions {
    ...
    my $sc = getComplement($s_sequence);
    while ($sc =~/$s_motif/ig){
        push (@a_positions, pos($sc) - length($&));
    }
